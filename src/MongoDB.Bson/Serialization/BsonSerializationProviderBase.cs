...
namespace Etherna.MongoDB.Bson.Serialization
{
    ...
    public abstract class BsonSerializationProviderBase : IRegistryAwareBsonSerializationProvider
    {
        ...
        {
            return GetSerializer(type, BsonSerializer.GetSerializerRegistry());
        }
        ...
        {
            return CreateGenericSerializer(serializerTypeDefinition, typeArguments, BsonSerializer.GetSerializerRegistry());
        }
        ...
        {
            return CreateSerializer(serializerType, BsonSerializer.GetSerializerRegistry());
        }
