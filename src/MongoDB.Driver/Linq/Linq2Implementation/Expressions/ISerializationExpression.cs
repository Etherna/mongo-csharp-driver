...
namespace Etherna.MongoDB.Driver.Linq.Linq2Implementation.Expressions
{
    ...
    internal static class ISerializationExpressionExtensions
    {
        ...
        public static BsonValue SerializeValue(this ISerializationExpression field, Type valueType, object value)
        {
            ...
            var valueSerializer = FieldValueSerializerHelper.GetSerializerForValueType(field.Serializer, BsonSerializer.GetSerializerRegistry(), valueType, value);
        ...
        public static BsonArray SerializeValues(this ISerializationExpression field, Type itemType, IEnumerable values)
        {
            ...
            var itemSerializer = FieldValueSerializerHelper.GetSerializerForValueType(field.Serializer, BsonSerializer.GetSerializerRegistry(), itemType);
