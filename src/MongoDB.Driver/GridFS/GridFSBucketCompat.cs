...
namespace Etherna.MongoDB.Driver.GridFS
{
    ...
    public class GridFSBucket : GridFSBucket<ObjectId>, IGridFSBucket
    {
        ...
        {
            var renderedFilter = filter.Render(new(GridFSFileInfoSerializer.Instance, BsonSerializer.GetSerializerRegistry(), translationOptions: translationOptions));
        ...
        private GridFSFindOptions<ObjectId> WrapFindOptions(GridFSFindOptions options, ExpressionTranslationOptions translationOptions)
        {
            if (options != null)
            {
                var renderedSort = options.Sort == null ? null : options.Sort.Render(new(GridFSFileInfoSerializer.Instance, BsonSerializer.GetSerializerRegistry(), translationOptions: translationOptions));
