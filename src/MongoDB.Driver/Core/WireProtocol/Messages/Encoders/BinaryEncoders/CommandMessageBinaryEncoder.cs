            ...
            bool forceStaticSerializerRegistry)
        {
            ...
            switch (section)
            {
                ...
                case Type1CommandMessageSection type1Section:
                    ...
                    type1SectionFormatter.FormatSection(type1Section, writer, forceStaticSerializerRegistry);
                    break;
                case ClientBulkWriteOpsCommandMessageSection bulkWriteOpsSection:
                    ...
                    {
                        bulkWriteOpsSectionFormatter.FormatSection(bulkWriteOpsSection, writer, forceStaticSerializerRegistry);
                    }
