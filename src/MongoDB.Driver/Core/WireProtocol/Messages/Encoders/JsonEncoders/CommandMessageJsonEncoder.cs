...
namespace Etherna.MongoDB.Driver.Core.WireProtocol.Messages.Encoders.JsonEncoders
{
    internal sealed class CommandMessageJsonEncoder : MessageJsonEncoderBase, IMessageEncoder
    {
            ...
            bool forceStaticSerializerRegistry)
        {
            ...
            WriteSections(writer, message.Sections, forceStaticSerializerRegistry);
        ...
        void IMessageEncoder.WriteMessage(
            ...
            bool forceStaticSerializerRegistry)
        {
            WriteMessage((CommandMessage)message, forceStaticSerializerRegistry);
        }
            ...
            bool forceStaticSerializerRegistry)
        {
            ...
            switch (section)
            {
                case Type0CommandMessageSection type0Section:
                    __type0SectionFormatter.FormatSection(type0Section, writer, forceStaticSerializerRegistry);
                    break;

                case Type1CommandMessageSection type1Section:
                    __type1SectionFormatter.FormatSection(type1Section, writer, forceStaticSerializerRegistry);
                    break;
            ...
            bool forceStaticSerializerRegistry)
        {
            ...
            {
                WriteSection(writer, section, forceStaticSerializerRegistry);
            }
